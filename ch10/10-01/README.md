...
0번 버튼 눌리면 (ON)  : 불을 켠다 <br>
0번 버튼 올라오면 (OFF)  : 불을 끈다 <br>
1번 버튼 눌리면 (ON)  : 에어켠이나 히터를 켠다 <br>
1번 버튼 올라오면 (OFF)  : 에어켠이나 히터를 끈다 <br>
2번 버튼 눌리면 (ON)  : 음악을 켠다 <br>
2번 버튼 올라오면 (OFF)  : 음악을 끈다 <br>
3번 버튼 눌리면 (ON)  : 문을 연다 <br>
3번 버튼 올라오면 (OFF)  : 문들 닫는다 <br>
